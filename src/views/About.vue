<template>
  <div class="about">
    ...
    <p>
      ...
      pseudoslack usa y protege la información que es proporcionada por sus
    ...
    <p>
      pseudoslack está altamente comprometido para cumplir con el compromiso de
    ...
    <p>
      ...
      <a href="https://cupondedescuento.com.co/linio/" target="_blank"
        >visitas a una web </a
    ...
    <p>
      pseudoslack Se reserva el derecho de cambiar los términos de la presente
